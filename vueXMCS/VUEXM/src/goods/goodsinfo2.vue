...
export default {
    data(){
		return {
			...
			xs:false,
			selectcount:1,
 id:2,title:'[顺丰包邮]中兴6.53英寸水滴全面屏智能手机',nowmoney:'398',oldmoney:'￥799',img:'https://img.alicdn.com/imgextra/i3/29286077/O1CN01Pi5mfI1ulJTO4sW50_!!0-saturn_solar.jpg_240x240xz.jpg_.webp'
		}
	},
	components:{
